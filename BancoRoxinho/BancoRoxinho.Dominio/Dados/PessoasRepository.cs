...
namespace BancoRoxinho.Dominio.Dados
{
    ...
    {
        public readonly static string CONNECTIONSTRING = "Server=localhost\\SQLEXPRESS; Database=Aulas50;Integrated Security=SSPI";
        ...
        public List<PessoaFisica> ObterPessoasFisicas()
        {
            ...
            var sqlCommand = new SqlCommand("SELECT CPF," +
                "Nome," + "Sobrenome," +
                "Idade," + "Endereco FROM PessoaFisica;", conexaoBancoDeDados);
        ...
        public void CriarPessoaFisica()
        {
             ...
             * INSERT INTO PessoaFisica (
                Nome, Sobrenome, Endereco, CPF, IdContaCorrente
                 ...
                 'Jaques', 'Alves', 'Av. Pasteur', '000.000.000.-00', 1
                    );
             *  
             * 
             * 
